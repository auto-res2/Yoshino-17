...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration19")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration19/images/training_accuracy",
        )
        print("Figures generated: .research/iteration19/images/training_accuracy.pdf")
