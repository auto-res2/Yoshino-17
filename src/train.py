...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration24")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration24/images/training_accuracy",
        )
        print("Figures generated: .research/iteration24/images/training_accuracy.pdf")
