...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration20")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration20/images/training_accuracy",
        )
        print("Figures generated: .research/iteration20/images/training_accuracy.pdf")
