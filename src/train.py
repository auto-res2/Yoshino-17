...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration21")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration21/images/training_accuracy",
        )
        print("Figures generated: .research/iteration21/images/training_accuracy.pdf")
