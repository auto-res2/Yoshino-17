...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration32")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration32/images/training_accuracy",
        )
        print("Figures generated: .research/iteration32/images/training_accuracy.pdf")
