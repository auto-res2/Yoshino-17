...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration31")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration31/images/training_accuracy",
        )
        print("Figures generated: .research/iteration31/images/training_accuracy.pdf")
