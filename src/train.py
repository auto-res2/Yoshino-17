...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration30")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration30/images/training_accuracy",
        )
        print("Figures generated: .research/iteration30/images/training_accuracy.pdf")
