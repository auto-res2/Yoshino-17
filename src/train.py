...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration18")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration18/images/training_accuracy",
        )
        print("Figures generated: .research/iteration18/images/training_accuracy.pdf")
