...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration25")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration25/images/training_accuracy",
        )
        print("Figures generated: .research/iteration25/images/training_accuracy.pdf")
