...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration27")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration27/images/training_accuracy",
        )
        print("Figures generated: .research/iteration27/images/training_accuracy.pdf")
