...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration26")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration26/images/training_accuracy",
        )
        print("Figures generated: .research/iteration26/images/training_accuracy.pdf")
