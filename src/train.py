...
class Trainer:
    ...
    def fit(self):
        ...
        # ---------- persist ----------
        result_dir = pathlib.Path(".research/iteration11")
        ...
        line_plot(
            ...
            "CertAcc",
            ".research/iteration11/images/training_accuracy",
        )
        print("Figures generated: .research/iteration11/images/training_accuracy.pdf")